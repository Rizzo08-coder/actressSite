...
@section('body')
    ...
    <div class="mx-32 max-lg:mx-24 max-md:mx-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 mb-32">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                <h2 class="text-2xl font-bold text-gray-800">{{strtoupper($show->title)}}</h2>
                <p class="text-gray-600 mt-2">
                    {{$show->short_description}}
                </p>
                <div class="mt-4">
                    <span class="text-sm text-gray-500">Data di creazione: 25 gennaio 2025 {{\Carbon\Carbon::parse($show->data_creation)->format('d/m/Y')}}</span>
                </div>
